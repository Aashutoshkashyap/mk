...
const contactInfo = [
  {
    icon: Mail,
    title: "Email Us",
    details: ["casubratsapkota@gmail.com", "cadiwashdahal@gmail.com"],
    action: { label: "Send Email", href: "mailto:cadiwashdahal@gmail.com" },
  },
  {
    icon: MapPin,
    title: "Visit Us",
    details: ["Sahabhagita Marga, Thapagaun-10", "New Baneshwor, Kathmandu, 44600", "Nepal"],
    action: { label: "Get Directions", href: "https://maps.app.goo.gl/b3zLKtJCErQ1KdXC6" },
  },
  {
    icon: Phone,
    title: "Call Us",
    details: ["+(977) 9841690746", "+(977) 9849501842"],
    action: { label: "Call Now", href: "tel:+9779841690746" },
  },
  {
    icon: Clock,
    title: "Working Hours",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <p className="mt-5 text-primary-foreground/70 max-w-xl mx-auto">
              Dedicated to delivering world-class service rooted in integrity, innovation, and excellence.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-secondary/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-border bg-secondary/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
                placeholder="How can we help you?"
              />
            </div>
            <button
              type="submit"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-8 py-3.5 text-sm font-bold text-primary-foreground hover:bg-brand-navy-dark transition-all shadow-lg shadow-primary/20"
            >
              <Send size={16} />
              Send Message
            </button>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl overflow-hidden border border-border shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.9!2d85.34!3d27.69!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjfCsDQxJzI0LjAiTiA4NcKwMjAnMjQuMCJF!5e0!3m2!1sen!2snp!4v1234567890"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Sharp Edge Business Solutions Location"
            />
          </div>
        </div>
      </section>
