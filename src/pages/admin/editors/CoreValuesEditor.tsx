    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Manage the foundational pillars and choose library or custom icons.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <IconPicker
                  ...
                  value={v.icon_name}
                  onChange={(val) => update(v.id, "icon_name", val)}
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-foreground mb-1">Value Title</label>
