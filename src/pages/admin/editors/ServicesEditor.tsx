  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="font-display text-2xl font-extrabold text-primary">Engineering Services</h2>
          <p className="text-xs text-muted-foreground mt-0.5">Edit service offerings and pick or upload custom icons.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <IconPicker
                  ...
                  value={svc.icon_name}
                  onChange={(val) => update(svc.id, "icon_name", val)}
                />
              </div>
